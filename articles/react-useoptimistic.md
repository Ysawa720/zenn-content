...
Supabase へのDB通信は一般的に 200〜600ms 程度です。電波が安定しているグラウンドなら 200ms 台に収まるかもしれませんが、試合中のWi-Fiや4G環境では 500ms 以上になることも普通にあります。
つまり**「少しもたつく」から「明らかに遅い」の間をうろうろする**状況です。投球のたびにこの遅延が発生すると、記録作業のテンポが崩れます。楽観的UIでタップ即反映にすることで、この問題を解消できます。
